...
//  }
    ...
    public <SC extends BaseEntity, DC> PostConverterBuilder<S, D> addChildCollectionConverterFrom(OneToManyConversionAccess<S, D, SC, DC> oneToManyConversionAccess) {
        chainedConverter.addConverter(new OneToManyCollectionConverter<S, D, SC, DC>(oneToManyConversionAccess));
        return this;
    }
    
    public <SC extends BaseEntity, DC> PostConverterBuilder<S, D> addChildEntityConverterFrom(OneToOneConversionAccess<S, D, SC, DC> oneToOneConversionAccess) {
