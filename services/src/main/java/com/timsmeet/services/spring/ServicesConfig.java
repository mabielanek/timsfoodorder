...
public class ServicesConfig {
	...
	public FindEntityWithIdAccessor<ProviderVacationEntity> getProviderVacationFind() {
		...
		providerVacationFind.setIdAccessor(new IdAccessors.VacationById<ProviderVacationEntity>());
	...
	public FindEntityWithIdAccessor<ProviderWorkingHourEntity> getProviderWorkingHourFind() {
		...
		providerWorkingHourFind.setIdAccessor(new IdAccessors.WorkingHourById<ProviderWorkingHourEntity>());
	...
	public FindEntityWithIdAccessor<EmailEntity> getEmailFind() {
		...
		emailFind.setIdAccessor(new IdAccessors.EmailById());
		return emailFind;
	}
	...
	public FindEntityWithIdAccessor<PhoneEntity> getPhoneFind() {
		...
		phoneFind.setIdAccessor(new IdAccessors.PhoneById());
		return phoneFind;
	}
	...
	public FindEntityWithIdAccessor<WebUrlEntity> getWebUrlFind() {
		...
		webUrlFind.setIdAccessor(new IdAccessors.WebUrlById());
		return webUrlFind;
	}
	...
	public FindEntityWithIdAccessor<DishComponentEntity> getDishComponentFind() {
	    ...
	    dishComponentFind.setIdAccessor(new IdAccessors.DishComponentById());
	...
	public FindEntityWithIdAccessor<DishElementEntity> getDishElementFind() {
	    ...
	    dishElementFind.setIdAccessor(new IdAccessors.DishElementById());
	...
	public FindEntityWithIdAccessor<GenereEntity> getGenereFind() {
	    ...
	    genereFind.setIdAccessor(new IdAccessors.GenereById());
	    return genereFind;
	}
	...
	public FindEntityWithIdAccessor<DishGenereEntity> getDishGenereFind() {
	    ...
	    dishGenereFind.setIdAccessor(new IdAccessors.DishGenereByGenereId());
	...
	public FindEntityWithIdAccessor<DishEntity> getDishFind() {
	    ...
	    dishFind.setIdAccessor(new IdAccessors.DishById());
	    return dishFind;
	}
}
