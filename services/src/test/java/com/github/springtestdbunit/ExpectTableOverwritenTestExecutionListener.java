 ...
 * @author Phillip Webb
 */
public class ExpectTableOverwritenTestExecutionListener extends AbstractTestExecutionListener {

    private static final Log logger = LogFactory.getLog(ExpectTableOverwritenTestExecutionListener.class);
    ...
    private static ExpectedDatabaseTableTestOverwriteDbUnitRunner runner = new ExpectedDatabaseTableTestOverwriteDbUnitRunner();
